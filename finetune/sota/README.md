...
两个最佳检查点的**硬链接**(同 inode,删原文件不影响这里)。已加 `.gitignore`(.pt 不进 git)。
...
- 原文件:`/home/tfbao/Shiyu/Summer/BERT/NLP_BERT_CRF/output_v65_mt_fgm_crf/best.pt`

### 单 CWS(v6 + FGM 5ep)
- backbone:`bert_train_v6_mid`(v4 + 5B WWM CPT,corpus 重叠)
- fine-tune:CWS single-task + FGM eps=1.0,5 epoch
- 原文件:`/home/tfbao/Shiyu/Summer/BERT/NLP_BERT_CRF/output_v6_fgm5_crf/best.pt`
